...
const (
	...
	VKFLY_CMD_NAV_WP MAV_CMD = 44010
	// VKFLY custom throwing waypoint command.
	VKFLY_CMD_NAV_WP_THROW MAV_CMD = 44011
	// VLFLY Custom orbit waypoint
	VKFLY_CMD_NAV_WP_ORBIT_DO_PHOTO MAV_CMD = 44012
	// VLFLY Custom orbit waypoint
	VKFLY_CMD_NAV_EDU_TRAINING MAV_CMD = 44013
	// VLFLY Custom orbit waypoint
	VKFLY_CMD_MOUNT_CTRL MAV_CMD = 44030
	// Formation fly assemble, disband or change formation
	VKFLY_CMD_FORMATION_FLY MAV_CMD = 44031
	// can esc id configuration
	VKFLY_CMD_ESC_CONFIG MAV_CMD = 44050
	// can esc id configuration
	VKFLY_CMD_RFD_CONFIG MAV_CMD = 44051
	// Do reposition and throwing
	VKFLY_CMD_DO_REPOSITION_THAN_THROW MAV_CMD = 44060
	// Do reposition and throwing
	VKFLY_CMD_DO_REPOSITION_THAN_LAND MAV_CMD = 44061
	// Start mission
	VKFLY_CMD_MISSION_START MAV_CMD = 44062
	// Return to launch position than land
	VKFLY_CMD_RETURN_TO_LAUCH MAV_CMD = 44063
	// Weigher config command
	VKFLY_CMD_WEIGHER_CONFIG MAV_CMD = 44064
	// Check fixedwing servos.
	VKFLY_CMD_DO_FIXEDWING_ACTUATOR_CHECK MAV_CMD = 44065
	// Set return circle point.
	VKFLY_CMD_SET_RTL_CIRCLE_WP MAV_CMD = 44066
	// Start mission
	VKFLY_CMD_MISSION_START_EDU_TRAINING MAV_CMD = 44067
	// Start mission
	VKFLY_CMD_RESUME_WP_ALT MAV_CMD = 44068
	// Start mission
	VKFLY_CMD_EXT_NAV_CFG MAV_CMD = 44069
	// Do reposition
	VKFLY_CMD_DO_REPOSITION MAV_CMD = 44070
	// Vehicle act
	VKFLY_CMD_DYNAMIC_ACT MAV_CMD = 44071
	// Do reposition then deploy parachute
	VKFLY_CMD_DO_REPOSITION_THAN_DO_PARACHUTE MAV_CMD = 44072
	// Vehicle act
	VKFLY_CMD_CLEAR_SERVO_DISPALY MAV_CMD = 44073
)
...
var value_to_label_MAV_CMD = map[MAV_CMD]string{
	...
	VKFLY_CMD_NAV_WP: "VKFLY_CMD_NAV_WP",
	VKFLY_CMD_NAV_WP_THROW: "VKFLY_CMD_NAV_WP_THROW",
	VKFLY_CMD_NAV_WP_ORBIT_DO_PHOTO: "VKFLY_CMD_NAV_WP_ORBIT_DO_PHOTO",
	VKFLY_CMD_NAV_EDU_TRAINING: "VKFLY_CMD_NAV_EDU_TRAINING",
	VKFLY_CMD_MOUNT_CTRL: "VKFLY_CMD_MOUNT_CTRL",
	VKFLY_CMD_FORMATION_FLY: "VKFLY_CMD_FORMATION_FLY",
	VKFLY_CMD_ESC_CONFIG: "VKFLY_CMD_ESC_CONFIG",
	VKFLY_CMD_RFD_CONFIG: "VKFLY_CMD_RFD_CONFIG",
	VKFLY_CMD_DO_REPOSITION_THAN_THROW: "VKFLY_CMD_DO_REPOSITION_THAN_THROW",
	VKFLY_CMD_DO_REPOSITION_THAN_LAND: "VKFLY_CMD_DO_REPOSITION_THAN_LAND",
	VKFLY_CMD_MISSION_START: "VKFLY_CMD_MISSION_START",
	VKFLY_CMD_RETURN_TO_LAUCH: "VKFLY_CMD_RETURN_TO_LAUCH",
	VKFLY_CMD_WEIGHER_CONFIG: "VKFLY_CMD_WEIGHER_CONFIG",
	VKFLY_CMD_DO_FIXEDWING_ACTUATOR_CHECK: "VKFLY_CMD_DO_FIXEDWING_ACTUATOR_CHECK",
	VKFLY_CMD_SET_RTL_CIRCLE_WP: "VKFLY_CMD_SET_RTL_CIRCLE_WP",
	VKFLY_CMD_MISSION_START_EDU_TRAINING: "VKFLY_CMD_MISSION_START_EDU_TRAINING",
	VKFLY_CMD_RESUME_WP_ALT: "VKFLY_CMD_RESUME_WP_ALT",
	VKFLY_CMD_EXT_NAV_CFG: "VKFLY_CMD_EXT_NAV_CFG",
	VKFLY_CMD_DO_REPOSITION: "VKFLY_CMD_DO_REPOSITION",
	VKFLY_CMD_DYNAMIC_ACT: "VKFLY_CMD_DYNAMIC_ACT",
	VKFLY_CMD_DO_REPOSITION_THAN_DO_PARACHUTE: "VKFLY_CMD_DO_REPOSITION_THAN_DO_PARACHUTE",
	VKFLY_CMD_CLEAR_SERVO_DISPALY: "VKFLY_CMD_CLEAR_SERVO_DISPALY",
}
