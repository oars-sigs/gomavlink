...
var value_to_label_MAV_ODID_CLASSIFICATION_TYPE = map[MAV_ODID_CLASSIFICATION_TYPE]string{
...
var label_to_value_MAV_ODID_CLASSIFICATION_TYPE = map[string]MAV_ODID_CLASSIFICATION_TYPE{
	"MAV_ODID_CLASSIFICATION_TYPE_UNDECLARED": MAV_ODID_CLASSIFICATION_TYPE_UNDECLARED,
	"MAV_ODID_CLASSIFICATION_TYPE_EU": MAV_ODID_CLASSIFICATION_TYPE_EU,
}
...
func (e MAV_ODID_CLASSIFICATION_TYPE) MarshalText() ([]byte, error) {
	if name, ok := value_to_label_MAV_ODID_CLASSIFICATION_TYPE[e]; ok {
...
func (e *MAV_ODID_CLASSIFICATION_TYPE) UnmarshalText(text []byte) error {
	if value, ok := label_to_value_MAV_ODID_CLASSIFICATION_TYPE[string(text)]; ok {
	   *e = value
