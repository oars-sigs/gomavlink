...
var values_MAV_GENERATOR_STATUS_FLAG = []MAV_GENERATOR_STATUS_FLAG{
...
var value_to_label_MAV_GENERATOR_STATUS_FLAG = map[MAV_GENERATOR_STATUS_FLAG]string{
...
var label_to_value_MAV_GENERATOR_STATUS_FLAG = map[string]MAV_GENERATOR_STATUS_FLAG{
	"MAV_GENERATOR_STATUS_FLAG_OFF": MAV_GENERATOR_STATUS_FLAG_OFF,
	"MAV_GENERATOR_STATUS_FLAG_READY": MAV_GENERATOR_STATUS_FLAG_READY,
	"MAV_GENERATOR_STATUS_FLAG_GENERATING": MAV_GENERATOR_STATUS_FLAG_GENERATING,
	"MAV_GENERATOR_STATUS_FLAG_CHARGING": MAV_GENERATOR_STATUS_FLAG_CHARGING,
...
func (e MAV_GENERATOR_STATUS_FLAG) MarshalText() ([]byte, error) {
	...
	var names []string
	for _, val := range values_MAV_GENERATOR_STATUS_FLAG {
		if e&val == val {
			names = append(names, value_to_label_MAV_GENERATOR_STATUS_FLAG[val])
		}
	}
...
func (e *MAV_GENERATOR_STATUS_FLAG) UnmarshalText(text []byte) error {
	...
	for _, label := range labels {
		if value, ok := label_to_value_MAV_GENERATOR_STATUS_FLAG[label]; ok {
			mask |= value
